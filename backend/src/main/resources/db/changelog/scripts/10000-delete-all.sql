...
truncate table monitor_checker_data_dns cascade;
truncate table monitor_checker_data_http cascade;
truncate table monitor_checker_data_ping cascade;
truncate table monitor_checker_data_push cascade;
truncate table monitor_checker_data_ssl_certificate cascade;
truncate table monitor_push_entry cascade;
truncate table notification_sender_data_discord cascade;
truncate table notification_sender_data_email cascade;
