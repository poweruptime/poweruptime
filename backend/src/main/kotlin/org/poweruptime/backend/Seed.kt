    ...
    fun seedDatabase(): CommandLineRunner = CommandLineRunner {
        ...
        transaction {
            Team.batchInsert(
                ...
                this[Team.name] = "Test Team $index"
            }
        }
        ...
        val methods = transaction {
            NotificationMethod.batchInsert((0..200)) { index ->
                this[NotificationMethod.name] = "Z Autogenerated $index"
                this[NotificationMethod.teamId] = testTeam.id
                this[NotificationMethod.type] = NotificationMethodType.EMAIL
            }.map {
        ...
        transaction {
            EmailNotificationMethodData.batchInsert(methods) { method ->
                this[EmailNotificationMethodData.id] = method.id
                this[EmailNotificationMethodData.to] = arrayListOf("test@test.at")
                this[EmailNotificationMethodData.host] = "test.at"
                this[EmailNotificationMethodData.port] = 1234
                this[EmailNotificationMethodData.username] = "test"
                this[EmailNotificationMethodData.password] = "test"
                this[EmailNotificationMethodData.security] = EmailSecurity.NONE_STARTTLS
                this[EmailNotificationMethodData.ignoreTLSErrors] = true
            }
        }
...
class CheckResultSeedService {
    ...
    fun insert(now: Instant, monitorId: ULong, ids: List<Long>) {
        CheckResult.batchInsert(ids) {
            ...
            this[CheckResult.message] = "Test - OK"
        }
    }
}
