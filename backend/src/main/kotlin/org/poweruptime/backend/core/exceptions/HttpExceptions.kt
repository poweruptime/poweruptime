...
open class TooManyRequestsException(message: String = "Too many requests", codeName: String? = null) : HttpException(
    HttpStatus.TOO_MANY_REQUESTS,
    message,
    codeName,
)

open class ServiceUnavailableException(message: String = "Service unavailable") : HttpException(
