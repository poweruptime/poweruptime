...
object MonitorTable : ULongIdTable("monitor"), HasPublicId, HasModifiers, HasSoftDelete, HasName {
...
fun MonitorTable.rowToMonitorRecord(row: ResultRow): MonitorRecord =
    MonitorRecord(
        id = row[id].value,
