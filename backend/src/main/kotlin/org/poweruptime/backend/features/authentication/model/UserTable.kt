...
object UserTable : ULongIdTable(""""user""""), HasPublicId, HasModifiers, HasSoftDelete, HasName {
    ...
    val mfaId = ulong("mfa_id").references(MFATable.id).nullable()
...
fun UserTable.rowToUserRecord(row: ResultRow, alias: Alias<UserTable>): UserRecord =
    UserRecord(
