...
@Entity(name = "${NOTIFICATION_SENDER_DATA_TABLE_NAME}_${NotificationSenderTypes.SLACK}")
@DiscriminatorValue(NotificationSenderTypes.SLACK)
class SlackNotificationSenderData(
