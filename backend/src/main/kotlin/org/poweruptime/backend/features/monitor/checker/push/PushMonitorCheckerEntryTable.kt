...
object PushMonitorCheckerEntryTable : ULongIdTable("monitor_push_entry"), HasPublicId, HasModifiers {
...
fun PushMonitorCheckerEntryTable.rowToPushMonitorCheckerEntryRecord(row: ResultRow): PushMonitorCheckerEntryRecord =
