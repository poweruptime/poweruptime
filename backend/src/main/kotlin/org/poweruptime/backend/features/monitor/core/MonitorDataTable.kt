...
abstract class MonitorDataTable(@Suppress("PropertyName", "ConstructorParameterNaming") val _type: MonitorType) :
    ...
    companion object {
        ...
        fun getByType(type: MonitorType): MonitorDataTable = registry[type] ?: error("Unknown monitor type: $type")
    }
}
