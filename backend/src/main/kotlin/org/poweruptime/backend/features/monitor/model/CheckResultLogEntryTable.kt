...
object CheckResultLogEntryTable : ULongIdTable("check_result_log_entry"), HasModifiers, HasPublicId {
    override val publicId = nanoId("public_id", NANO_ID_MAX_LENGTH)
    override val createdAt = createdAt()
    override val updatedAt = updatedAt()

    val checkResultId = ulong("check_result_id").references(CheckResultTable.id).index()
...
fun CheckResultLogEntryTable.rowToCheckResultLogEntry(row: ResultRow): CheckResultLogEntryRecord =
