...
object StatusPageDomainNameTable : ULongIdTable("status_page_domain_name"), HasModifiers, HasName {
...
fun StatusPageDomainNameTable.rowToStatusPageDomainNameRecord(row: ResultRow): StatusPageDomainNameRecord =
