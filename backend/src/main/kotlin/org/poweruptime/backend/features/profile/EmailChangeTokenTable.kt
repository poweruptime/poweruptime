...
object EmailChangeTokenTable : ULongIdTable("email_change_token"), HasPublicId, HasModifiers {
...
fun EmailChangeTokenTable.rowToEmailChangeTokenRecord(row: ResultRow): EmailChangeTokenRecord =
