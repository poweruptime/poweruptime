...
class PingMonitorChecker : MonitorChecker {
    private val logger: Logger = LoggerFactory.getLogger(PingMonitorCheckerData::class.java)

    override val type = MonitorCheckerType.PING

    override fun execute(monitor: Monitor): CheckResultDto {
        val pingMonitorCheckerData = monitor.checker as PingMonitorCheckerData
