...
class DNSMonitorCheckerTest {
    ...
    @Test
    fun `test if simple A record works`(): Unit = dnsMonitorChecker
        .execute(
    ...
    @Test
    fun `test if simple CNAME record works`(): Unit = dnsMonitorChecker
        .execute(
            ModelFactory.getTestMonitor(MonitorType.DNS),
            DnsMonitorDataRecord(
                host = "playground.dafnik.me",
    ...
    @Test
    fun `test if fails simple CNAME record works`(): Unit = dnsMonitorChecker
        .execute(
            ModelFactory.getTestMonitor(MonitorType.DNS),
            DnsMonitorDataRecord(
    ...
    @Test
    fun `test not existing DNS server`(): Unit = dnsMonitorChecker
        .execute(
            ModelFactory.getTestMonitor(MonitorType.DNS),
            DnsMonitorDataRecord(
                host = "playground.dafnik.me",
    ...
    @Test
    fun `test if A records work`(): Unit = dnsMonitorChecker
        .execute(
            ModelFactory.getTestMonitor(MonitorType.DNS),
            DnsMonitorDataRecord(
                host = "playground.dafnik.me",
    ...
    @Test
    fun `test if CNAME records work`(): Unit = dnsMonitorChecker
        .execute(
            ModelFactory.getTestMonitor(MonitorType.DNS),
            DnsMonitorDataRecord(
                host = "playground.dafnik.me",
    ...
    @Test
    fun `test if fail A records`(): Unit = dnsMonitorChecker
        .execute(
            ModelFactory.getTestMonitor(MonitorType.DNS),
            DnsMonitorDataRecord(
                host = "playground.dafnik.me",
    ...
    @Test
    fun `test if fail CNAME records`(): Unit = dnsMonitorChecker
        .execute(
            ModelFactory.getTestMonitor(MonitorType.DNS),
            DnsMonitorDataRecord(
                host = "playground.dafnik.me",
    ...
    @Test
    fun `test if fail CNAME records with working and not working`(): Unit = dnsMonitorChecker
        .execute(
            ModelFactory.getTestMonitor(MonitorType.DNS),
            DnsMonitorDataRecord(
                host = "playground.dafnik.me",
