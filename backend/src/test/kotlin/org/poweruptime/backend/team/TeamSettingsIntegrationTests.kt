...
class TeamSettingsIntegrationTests(
    ...
    @Nested
    @DisplayName("API Put /v1/team/{teamId}/setting/checkResultRetentionPeriodInDays")
    inner class UpdateCheckResultRetentionPeriodInDays {
        @Test
        fun `test if secured`() {
            mockMvc.put("/v1/team/4Lxhu5YKWPBr/setting/checkResultRetentionPeriodInDays") {
                contentType = MediaType.APPLICATION_JSON
                content = SettingIntDto(30).toJSON()
            }.andExpect {
                status { isUnauthorized() }
            }
        }
        ...
        fun `test success instance setting change affecting default team setting`() {
            ...
            instanceSettingService.setCheckResultRetentionPeriodInDays(420)

            mockMvc.get("/v1/team/4Lxhu5YKWPBr/setting").andExpect {
                status { isOk() }
                content {
                    jsonPath("$.checkResultRetentionPeriodInDays") { value(420) }
                }
            }
        }
        ...
        fun `test success with admin`() {
            mockMvc.put("/v1/team/4Lxhu5YKWPBr/setting/checkResultRetentionPeriodInDays") {
                contentType = MediaType.APPLICATION_JSON
                content = SettingIntDto(60).toJSON()
            }.andExpect {
                status { isAccepted() }
                content {
                    contentType(MediaType.APPLICATION_JSON)
                    jsonPath("$.checkResultRetentionPeriodInDays") {
                        value(60)
                    }
                }
            }
        ...
        fun `test success with team admin user`() {
            mockMvc.put("/v1/team/4Lxhu5YKWPBr/setting/checkResultRetentionPeriodInDays") {
                contentType = MediaType.APPLICATION_JSON
                content = SettingIntDto(45).toJSON()
            }.andExpect {
                status { isAccepted() }
                content {
                    contentType(MediaType.APPLICATION_JSON)
                    jsonPath("$.checkResultRetentionPeriodInDays") { value(45) }
                }
            }
        }
        ...
        @Test
        @MockAdmin
        fun `test value persistence`() {
            mockMvc.put("/v1/team/4Lxhu5YKWPBr/setting/checkResultRetentionPeriodInDays") {
                contentType = MediaType.APPLICATION_JSON
                content = SettingIntDto(90).toJSON()
            }.andExpect {
                status { isAccepted() }
            }
    ...
    @Nested
    @DisplayName(
        "API Put /v1/team/{teamId}/setting/checkResultLogRetentionPeriodInDays",
    )
    inner class UpdateCheckResultLogRetentionPeriodInDays {
        @Test
        fun `test if secured`() {
            mockMvc.put(
                "/v1/team/4Lxhu5YKWPBr/setting/checkResultLogRetentionPeriodInDays",
            ) {
                contentType = MediaType.APPLICATION_JSON
                content = SettingIntDto(30).toJSON()
            }.andExpect {
        ...
        fun `test success instance setting change affecting default team setting`() {
            ...
            instanceSettingService.setCheckResultLogRetentionPeriodInDays(69)

            mockMvc.get("/v1/team/4Lxhu5YKWPBr/setting").andExpect {
                status { isOk() }
                content {
                    jsonPath("$.checkResultLogRetentionPeriodInDays") { value(69) }
                }
            }
        }
        ...
        fun `test success with admin`() {
            mockMvc.put(
                ...
                content {
                    contentType(MediaType.APPLICATION_JSON)
                    jsonPath("$.checkResultLogRetentionPeriodInDays") { value(30) }
                }
            }
        }
        ...
        fun `test success with team admin user`() {
            mockMvc.put(
                ...
                contentType = MediaType.APPLICATION_JSON
                content = SettingIntDto(15).toJSON()
            }.andExpect {
                status { isAccepted() }
                content {
                    contentType(MediaType.APPLICATION_JSON)
                    jsonPath("$.checkResultLogRetentionPeriodInDays") { value(15) }
                }
            }
        }
        ...
        fun `test value persistence`() {
            mockMvc.put(
                ...
                contentType = MediaType.APPLICATION_JSON
                content = SettingIntDto(7).toJSON()
            }.andExpect {
                status { isAccepted() }
            }
            ...
            mockMvc.get("/v1/team/4Lxhu5YKWPBr/setting").andExpect {
                status { isOk() }
                content {
                    jsonPath("$.checkResultLogRetentionPeriodInDays") { value(7) }
                }
            }
        }
    }
