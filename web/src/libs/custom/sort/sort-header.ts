...
/** Column definition associated with a `HlmSortHeader`. */
interface HlmSortHeaderColumnDef {
  name: string;
}
 ...
 *
 * Must be provided with an id and contained within a parent HlmSort directive.
 *
 * If used on header cells in a CdkTable, it will automatically default its id from its containing
 * column definition.
 */
@Component({
  selector: '[hlm-sort-header]',
  exportAs: 'hlmSortHeader',
  templateUrl: 'sort-header.html',
  styleUrls: ['sort-header.scss'],
  host: {
    class: 'hlm-sort-header',
    '(click)': '_toggleOnInteraction()',
    '(keydown)': '_handleKeydown($event)',
    '(mouseleave)': '_recentlyCleared.set(null)',
    '[attr.aria-sort]': '_getAriaSortAttribute()',
    '[class.hlm-sort-header-disabled]': '_isDisabled()',
  },
  encapsulation: ViewEncapsulation.None,
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class HlmSortHeader implements HlmSortable, OnDestroy, OnInit, AfterViewInit {
  _sort = inject(HlmSort, {optional: true})!;
  _columnDef = inject<HlmSortHeaderColumnDef>(hlmSortHeaderColumnDef, {
    optional: true,
  });
   ...
   * the column's name.
   */
  @Input('hlm-sort-header') id!: string;

  /** Sets the position of the arrow that displays when sorted. */
  @Input() arrowPosition: SortHeaderArrowPosition = 'after';

  /** Overrides the sort start value of the containing HlmSort for this HlmSortable. */
  ...
  /**
   * Description applied to HlmSortHeader's button element with aria-describedby. This text should
  ...
  /** Overrides the disable clear value of the containing HlmSort for this HlmSortable. */
  @Input({transform: booleanAttribute})
  ...
  constructor() {
    const defaultOptions = inject<HlmSortDefaultOptions>(HLM_SORT_DEFAULT_OPTIONS, {
      optional: true,
    });
  ...
  ngOnInit() {
    ...
    this._sortButton = this._elementRef.nativeElement.querySelector('.hlm-sort-header-container')!;
  ...
  /** Whether this HlmSortHeader is currently sorted in either ascending or descending order. */
  _isSorted() {
    return (
